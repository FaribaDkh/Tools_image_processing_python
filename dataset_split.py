...
segs_path = "E:\\camelyon16\\dataset_for_training\\level_2\\not_splitted\\masks\\"
images_path = "E:\\camelyon16\\dataset_for_training\\level_2\\not_splitted\\imgs\\"
...
for i in range(len(train_indices)):
    ...
    im_mask = cv2.imread(segs_path + filename + "_mask" +".png",0)
    ...
    if (is_sorta_black(im_mask)):  # Get the RGBA Value of the a pixel of an image
        im_mask = im_mask * 255
    cv2.imwrite(dst_imgs_path + "\\train\\" + filename + ".png", im_mask)
    im.save(dst_imgs_path + "\\train_mask\\" + filename + ".png")
